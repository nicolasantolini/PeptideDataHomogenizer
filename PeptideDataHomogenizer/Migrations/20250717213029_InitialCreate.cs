        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PubMedId = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                    Title = table.Column<string>(type: "nvarchar(600)", maxLength: 600, nullable: false),
                    Journal = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    registration_token = table.Column<long>(type: "bigint", maxLength: 500, nullable: true),
                    registration_token_expiration = table.Column<DateTime>(type: "datetime2", nullable: true),
                    has_registered = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    software_name = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    logo_data = table.Column<byte[]>(type: "varbinary(max)", maxLength: 26214400, nullable: false),
                    content_type = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    website_url = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    method_name = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    water_model_name = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                    water_model_type = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    image_data = table.Column<byte[]>(type: "varbinary(max)", maxLength: 26214400, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    caption = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    tableJson = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    article_doi = table.Column<string>(type: "nvarchar(255)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsDiscredited = table.Column<bool>(type: "bit", nullable: false),
                    DiscreditedReason = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: false),
                    IsApproved = table.Column<bool>(type: "bit", nullable: false),
                    datetime_approval = table.Column<DateTime>(type: "datetime2", nullable: true),
                    approved_by = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    title = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                    project_id = table.Column<int>(type: "int", nullable: false),
                    discredited_reason = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: false),
                    discredited_by = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    protein_id = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    classification = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                    organism = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                    method = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                    residue = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    binder = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                    software_name = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                    software_version = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                    water_model = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                    water_model_type = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    force_field = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                    simulation_method = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                    temperature = table.Column<double>(type: "float", nullable: false),
                    ions = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                    ion_concentration = table.Column<double>(type: "float", nullable: false),
                    simulation_length = table.Column<double>(type: "float", nullable: false),
                    Kd = table.Column<double>(type: "float", nullable: false),
                    KOff = table.Column<double>(type: "float", nullable: false),
                    KOn = table.Column<double>(type: "float", nullable: false),
                    free_binding_energy = table.Column<double>(type: "float", nullable: false),
                    ProjectId = table.Column<int>(type: "int", nullable: false),
