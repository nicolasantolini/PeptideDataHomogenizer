...
{
    public static class ContextCookieManager
    {
        ...
        public static async Task SetContextAsync(IJSRuntime jsRuntime, int organizationId, int days = 7)
        {
        ...
        public static async Task<int?> GetContextAsync(IJSRuntime jsRuntime)
        {
